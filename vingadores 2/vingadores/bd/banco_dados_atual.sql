...
INSERT INTO `chip_gps` VALUES (1,'Localização Inicial','Localização Inicial',2),(2,'Localização Inicial','Localização Inicial',3),(3,'Localização Inicial','Localização Inicial',3),(4,'Localização Inicial','Localização Inicial',3),(5,'Localização Inicial','Localização Inicial',2),(6,'Localização Inicial','Localização Inicial',3),(7,'Localização Inicial','Localização Inicial',3),(8,'Localização Inicial','Localização Inicial',3),(9,'Localização Inicial','Localização Inicial',3),(10,'Localização Inicial','Localização Inicial',3),(11,'Localização Inicial','Localização Inicial',3);
...
INSERT INTO `heroi` VALUES (1,'ad','ad','Meta-Humano',3000,1,'um, dois','tres','quatro'),(2,'Homem Aranha','Peter Parkinson','Meta-Humano',3000,1,'agilidade, teia','sentido aranha','pneumoultramicroscopicosilicovulcanoconiose, homem'),(4,'Homem de Ferro','Tony Stark','Humano',6500,1,'Inteligencia','Tecnologias de combate avancado','pneumoultramicroscopicosilicovulcanoconiose');
...
CREATE TABLE `tornozeleira` (
  ...
  `heroi_id` int DEFAULT NULL,
  `chip_gps_id` int DEFAULT NULL,
  PRIMARY KEY (`tornozeleira_id`),
  KEY `heroi_id` (`heroi_id`),
  KEY `chip_tornozeleira_idx` (`chip_gps_id`),
  CONSTRAINT `chip_tornozeleira` FOREIGN KEY (`chip_gps_id`) REFERENCES `chip_gps` (`chip_gps_id`),
...
INSERT INTO `tornozeleira` VALUES (1,'Ativa','2024-12-06',NULL,4,NULL),(2,'Ativa','2024-12-06',NULL,2,NULL),(3,'Ativa','2024-12-06',NULL,1,NULL);
...
-- Dump completed on 2024-12-06 13:45:52
